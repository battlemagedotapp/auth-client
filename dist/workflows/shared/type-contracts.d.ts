...
export type WorkflowRootComponent<P> = (props: P & {
    children?: ReactNode;
}) => ReactNode;
export type EndpointValues<T, Extra extends PropertyKey = never> = Omit<NonNullable<T>, "fetchOptions" | Extra>;
...
//# sourceMappingURL=type-contracts.d.ts.map