...
The Release workflow is registered in `strawdotdev/auth-client`. Verify each published tag by installing it from that canonical repository; consumers must not depend on transfer redirects.
