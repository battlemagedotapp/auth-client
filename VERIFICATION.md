...
Remote GitHub authentication, workflow execution and the first actual release installation remain unverified until a remote exists. Browser/native journeys were not rerun for this packaging-only change. The reference application and working repository's commits/tags remain unchanged; only isolated fixtures get commits and tags.
